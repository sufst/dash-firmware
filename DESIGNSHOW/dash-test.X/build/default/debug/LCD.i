...
void I2C1_SetBuffer_4bitmode(uint8_t data_high, uint8_t data_low){
    uint8_t buffer[4];
    ...
    buffer[2] = (uint8_t)(data_low << 4) | 0x04;

    buffer[3] = (uint8_t)(data_low << 4);
...
void LCD_send_byte(uint8_t data, uint8_t rs){
    uint8_t data_high = (data & 0xF0) | (rs ? 0x01 : 0);
    uint8_t data_low = ((data << 4) & 0xF0) | (rs ? 0x01 : 0);

        I2C1_Open(0x38);

        I2C1_SetBuffer_4bitmode(data_high, data_low);
        I2C1_MasterWrite();
